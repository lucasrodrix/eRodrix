<div class="container_top">
    <h1 class="font-text-medium font-weight-medium text-left m-text-center">Produtos em Destaque:</h1>
    <div class="container_top_info">
    <ul class="caroussel">
            <?php 
                $read = $pdo->prepare("SELECT product_guid, product_name, product_headline, product_description, product_url, product_price, product_price_old, product_offers, product_thumb FROM {$product} WHERE status = :status ORDER BY rand() DESC");
