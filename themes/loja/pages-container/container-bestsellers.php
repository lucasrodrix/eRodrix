<div class="container_top">
    ...
    <ul class="caroussel">
            <?php 
                $read = $pdo->prepare("SELECT product_guid, product_name, product_headline, product_description, product_url, product_price, product_price_old, product_offers, product_thumb FROM {$product} WHERE status = :status AND product_offers IS NULL OR product_offers > 0");
